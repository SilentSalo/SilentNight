            ...
            if ImGui.BeginTabItem("Apartment") then
                if ImGui.BeginColumns(3) then
                    ...
                    if ClickGUI.BeginCustomChildWindow("Cuts") then
                        ...
                        ClickGUI.RenderFeature(apartmentBonus.hash)
            ...
            if ImGui.BeginTabItem("Cayo Perico") then
                if ImGui.BeginColumns(3) then
                    ...
                    if ClickGUI.BeginCustomChildWindow("Cuts") then
                        ...
                        ClickGUI.RenderFeature(cayoCrew.hash)
            ...
            if ImGui.BeginTabItem("Diamond Casino") then
                if ImGui.BeginColumns(3) then
                    ...
                    if ClickGUI.BeginCustomChildWindow("Cuts") then
                        ...
                        ClickGUI.RenderFeature(diamondCrew.hash)
...
ClickGUI.AddTab(string.format("Silent Night %s", VERSION), RenderClickGUI)

function RenderListGUI()
    local root = ListGUI.GetRootTab()
    if not root then return end

    local SilentNightTab = root:AddSubTab(string.format("Silent Night %s", VERSION), "Silent Night")
    ...
    if HeistToolTab then
        ...
        if ApartmentTab then
            ...
            ApartmentTab:AddFeature(apartmentBonus.hash)
        ...
        if CayoPericoTab then
            ...
            CayoPericoTab:AddFeature(cayoCrew.hash)
        ...
        if CasinoHeistTab then
            ...
            CasinoHeistTab:AddFeature(diamondCrew.hash)
    ...
    if MoneyToolTab then
        ...
        if MiscTab then
            ...
            EasyMoneyTab:AddFeature(easyGive30m.hash)
