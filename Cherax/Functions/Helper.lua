...
function Helper.ApplyApartmentPreset(preps)
    ...
    FeatureMgr.GetFeature(eFeature.Heist.Apartment.Cuts.Player1.Cut):SetIntValue(math.min(preps.player1.cut or 0, 100))
    FeatureMgr.GetFeature(eFeature.Heist.Apartment.Cuts.Player2.Cut):SetIntValue(math.min(preps.player2.cut or 0, 100))
    FeatureMgr.GetFeature(eFeature.Heist.Apartment.Cuts.Player3.Cut):SetIntValue(math.min(preps.player3.cut or 0, 100))
    FeatureMgr.GetFeature(eFeature.Heist.Apartment.Cuts.Player4.Cut):SetIntValue(math.min(preps.player4.cut or 0, 100))
...
function Helper.ApplyCayoPreset(preps)
    ...
    FeatureMgr.GetFeature(eFeature.Heist.CayoPerico.Cuts.Player1.Cut):SetIntValue(math.min(preps.player1.cut or 0, 100))
    FeatureMgr.GetFeature(eFeature.Heist.CayoPerico.Cuts.Player2.Cut):SetIntValue(math.min(preps.player2.cut or 0, 100))
    FeatureMgr.GetFeature(eFeature.Heist.CayoPerico.Cuts.Player3.Cut):SetIntValue(math.min(preps.player3.cut or 0, 100))
    FeatureMgr.GetFeature(eFeature.Heist.CayoPerico.Cuts.Player4.Cut):SetIntValue(math.min(preps.player4.cut or 0, 100))
...
function Helper.ApplyDiamondPreset(preps)
    ...
    FeatureMgr.GetFeature(eFeature.Heist.DiamondCasino.Cuts.Player1.Cut):SetIntValue(math.min(preps.player1.cut or 0, 100))
    FeatureMgr.GetFeature(eFeature.Heist.DiamondCasino.Cuts.Player2.Cut):SetIntValue(math.min(preps.player2.cut or 0, 100))
    FeatureMgr.GetFeature(eFeature.Heist.DiamondCasino.Cuts.Player3.Cut):SetIntValue(math.min(preps.player3.cut or 0, 100))
    FeatureMgr.GetFeature(eFeature.Heist.DiamondCasino.Cuts.Player4.Cut):SetIntValue(math.min(preps.player4.cut or 0, 100))
...
function Helper.ApplyDoomsdayPreset(preps)
    ...
    FeatureMgr.GetFeature(eFeature.Heist.Doomsday.Cuts.Player1.Cut):SetIntValue(math.min(preps.player1.cut or 0, 100))
    FeatureMgr.GetFeature(eFeature.Heist.Doomsday.Cuts.Player2.Cut):SetIntValue(math.min(preps.player2.cut or 0, 100))
    FeatureMgr.GetFeature(eFeature.Heist.Doomsday.Cuts.Player3.Cut):SetIntValue(math.min(preps.player3.cut or 0, 100))
    FeatureMgr.GetFeature(eFeature.Heist.Doomsday.Cuts.Player4.Cut):SetIntValue(math.min(preps.player4.cut or 0, 100))
