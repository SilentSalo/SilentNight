                ...
                if not HIDE_BUNKER_INFO then
                    if ImGui.BeginColumns(1) then
                        if ClickGUI.BeginCustomChildWindow("Information") then
                            ...
                            ImGui.TextColored("Max. Payout (Solo Session):", r, g, b, a, "$1,050,000")
                            ImGui.TextColored("Max. Payout (Full Session):", r, g, b, a, "$1,575,000")
                            local r, g, b, a = U(eBtnStyle.RED.Hovered)
                            ImGui.TextColored("Max. Payout («Max. Price»):", r, g, b, a, "$2,500,000")
                ...
                if not HIDE_HANGAR_CARGO_INFO then
                    if ImGui.BeginColumns(1) then
                        if ClickGUI.BeginCustomChildWindow("Information") then
                            local r, g, b, a = U(eBtnStyle.GREEN.Hovered)
                            ImGui.TextColored("Known limitations per sale:")
                            ImGui.TextColored("Max. Payout (Solo Session):", r, g, b, a, "$2,550,000")
                            ImGui.TextColored("Max. Payout (Full Session):", r, g, b, a, "$3,825,000")
                            local r, g, b, a = U(eBtnStyle.RED.Hovered)
                            ImGui.TextColored("Max. Payout («Max. Price»):", r, g, b, a, "$4,000,000")
                            ImGui.TextColored("Ignoring these limitations may result in a transaction error or even a ban!", r, g, b, a)
                ...
                if not HIDE_NIGHTCLUB_INFO then
                    if ImGui.BeginColumns(1) then
                        if ClickGUI.BeginCustomChildWindow("Information") then
                            local r, g, b, a = U(eBtnStyle.GREEN.Hovered)
                            ImGui.TextColored("Known limitations per sale:")
                            ImGui.TextColored("Max. Payout (Solo Session):", r, g, b, a, "$1,690,000")
                            ImGui.TextColored("Max. Payout (Full Session):", r, g, b, a, "$2,535,000")
                            local r, g, b, a = U(eBtnStyle.RED.Hovered)
                            ImGui.TextColored("Max. Payout («Max. Price»):", r, g, b, a, "$4,000,000")
                            ImGui.TextColored("Ignoring these limitations may result in a transaction error or even a ban!", r, g, b, a)
                ...
                if not HIDE_SPECIAL_CARGO_INFO then
                    if ImGui.BeginColumns(1) then
                        if ClickGUI.BeginCustomChildWindow("Information") then
                            local r, g, b, a = U(eBtnStyle.GREEN.Hovered)
                            ImGui.TextColored("Known limitations per sale:")
                            ImGui.TextColored("Max. Payout (Solo Session):", r, g, b, a, "$2,220,000")
                            ImGui.TextColored("Max. Payout (Full Session):", r, g, b, a, "$3,330,000")
                            local r, g, b, a = U(eBtnStyle.RED.Hovered)
                            ImGui.TextColored("Max. Payout («Max. Price»):", r, g, b, a, "$6,000,000")
