...
FeatureMgr.AddFeature(eFeature.Settings.Info.Copy)
...
FeatureMgr.AddFeature(eFeature.Settings.Config.Reset, function(f)
    ...
    FeatureMgr.GetFeature(eFeature.Settings.PocketDimension.Validation):Toggle(CONFIG.pocket_dimension.validation)
