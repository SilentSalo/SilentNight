...
eStat = {
    ...
    MPX_CWASH_SAFE_CASH_VALUE       = { type = "int",    stat = "CWASH_SAFE_CASH_VALUE"          },
    MPX_HDEN24_SAFE_CASH_VALUE      = { type = "int",    stat = "HDEN24_SAFE_CASH_VALUE"         },
    MPX_CLUB_SAFE_CASH_VALUE        = { type = "int",    stat = "CLUB_SAFE_CASH_VALUE"           },
    MPX_SALVAGE_SAFE_CASH_VALUE     = { type = "int",    stat = "SALVAGE_SAFE_CASH_VALUE"        },
    ...
    MPX_BITSET_HEIST_VS_MISSIONS    = { type = "int",    stat = "BITSET_HEIST_VS_MISSIONS"       },
    MPX_HEIST_SESSION_ID_MACADDR    = { type = "int",    stat = "HEIST_SESSION_ID_MACADDR"       },
    MPX_HEIST_LEADER_APART_ID       = { type = "int",    stat = "HEIST_LEADER_APART_ID"          },
    MPPLY_HEIST_PROGRESS_HASH       = { type = "int",    stat = "MPPLY_HEIST_PROGRESS_HASH"      },
    MPX_HEIST_TOTAL_REWARD_COSMETIC = { type = "int",    stat = "HEIST_TOTAL_REWARD_COSMETIC"    },
    MPX_HEIST_MISSION_RCONT_ID_0    = { type = "int",    stat = "HEIST_MISSION_RCONT_ID_0"       },
    MPX_HEIST_MISSION_DEPTH_LV_0    = { type = "int",    stat = "HEIST_MISSION_DEPTH_LV_0"       },
    MPX_HEIST_MISSION_DEPTH_LV_1    = { type = "int",    stat = "HEIST_MISSION_DEPTH_LV_1"       },
    MPX_HEIST_MISSION_DEPTH_LV_2    = { type = "int",    stat = "HEIST_MISSION_DEPTH_LV_2"       },
    MPX_HEIST_MISSION_DEPTH_LV_3    = { type = "int",    stat = "HEIST_MISSION_DEPTH_LV_3"       },
    MPX_HEIST_MISSION_DEPTH_LV_4    = { type = "int",    stat = "HEIST_MISSION_DEPTH_LV_4"       },
    MPX_HEIST_MISSION_DEPTH_LV_5    = { type = "int",    stat = "HEIST_MISSION_DEPTH_LV_5"       },
    MPX_HEIST_MISSION_DEPTH_LV_6    = { type = "int",    stat = "HEIST_MISSION_DEPTH_LV_6"       },
    MPX_HEIST_MISSION_DEPTH_LV_7    = { type = "int",    stat = "HEIST_MISSION_DEPTH_LV_7"       },
    MPX_SALV23_INST_PROG            = { type = "int",    stat = "SALV23_INST_PROG"               },
    MPX_SALV23_CFR_COOLDOWN         = { type = "int",    stat = "SALV23_CFR_COOLDOWN"            },
    MPX_HACKER24_INST_BS            = { type = "int",    stat = "HACKER24_INST_BS"               },
    MPX_HACKER24_MFM_COOLDOWN       = { type = "int",    stat = "HACKER24_MFM_COOLDOWN"          },
    ...
    MPX_HEIST_MISSION_RCONT_ID_1    = { type = "string", stat = "HEIST_MISSION_RCONT_ID_1"       },
    MPX_HEIST_MISSION_RCONT_ID_2    = { type = "string", stat = "HEIST_MISSION_RCONT_ID_2"       },
    MPX_HEIST_MISSION_RCONT_ID_3    = { type = "string", stat = "HEIST_MISSION_RCONT_ID_3"       },
    MPX_HEIST_MISSION_RCONT_ID_4    = { type = "string", stat = "HEIST_MISSION_RCONT_ID_4"       },
    MPX_HEIST_MISSION_RCONT_ID_5    = { type = "string", stat = "HEIST_MISSION_RCONT_ID_5"       },
    MPX_HEIST_MISSION_RCONT_ID_6    = { type = "string", stat = "HEIST_MISSION_RCONT_ID_6"       },
    MPX_HEIST_MISSION_RCONT_ID_7    = { type = "string", stat = "HEIST_MISSION_RCONT_ID_7"       },
